...
type SyncTypeRegistrySuite struct {
	suite.Suite
	Name   string
	Start  time.Time
...
func TestSyncTypeRegistrySuite(t *testing.T) {
	suite.Run(t, new(SyncTypeRegistrySuite))
}

// *****************************************************************************
// Suite Tools

func (suite *SyncTypeRegistrySuite) SetupSuite() {
	var err error
...
func (suite *SyncTypeRegistrySuite) TearDownSuite() {
	if suite.T().Failed() {
...
func (suite *SyncTypeRegistrySuite) BeforeTest(suiteName, testName string) {
	suite.Logger.Infof("Test Start: %s %s", testName, strings.Repeat("-", 80-13-len(testName)))
	suite.Start = time.Now()
}

func (suite *SyncTypeRegistrySuite) AfterTest(suiteName, testName string) {
	duration := time.Since(suite.Start)
	suite.Logger.Record("duration", duration.String()).Infof("Test End: %s %s", testName, strings.Repeat("-", 80-11-len(testName)))
}

func (suite *SyncTypeRegistrySuite) LoadTestData(filename string) []byte {
...
// *****************************************************************************
// Suite Tests
func ExampleSyncTypeRegistry_Unmarshal() {
	...
	registry := argo.NewSyncTypeRegistry[Something]().Add(Something1{}, Something2{})
...
func ExampleSyncTypeRegistry_Unmarshal_withTypeTag() {
	// Typically, each struct would be declared in its own go file
	// and the argo.TypeRegistry.Add() func would be done in the init() func of each file
	registry := argo.NewSyncTypeRegistry[Something]("__type").Add(Something1{}, Something2{})
...
func (suite *SyncTypeRegistrySuite) TestCanCreateTypeRegistry() {
	registry := argo.NewSyncTypeRegistry[core.TypeCarrier]()
	suite.Assert().NotNil(registry)
	suite.Assert().Len(registry.Typetags, 0)
}

func (suite *SyncTypeRegistrySuite) TestCanCreateTypeRegistryWithTypeTags() {
	registry := argo.NewSyncTypeRegistry[Something]("type1", "type2")
	suite.Assert().NotNil(registry)
	...
	registry = argo.NewSyncTypeRegistry[Something]()
...
func (suite *SyncTypeRegistrySuite) TestCanAddTypes() {
	// Here we do not use NewTypeRegistry, to test stuff works with default Go constructor
	registry := argo.SyncTypeRegistry[Something]{}
...
func (suite *SyncTypeRegistrySuite) TestCanUnmarshal() {
	registry := argo.NewSyncTypeRegistry[Something]().Add(Something1{}).Append(Something2{})
...
func (suite *SyncTypeRegistrySuite) TestCanUnmarshalWithTypeTag() {
	registry := argo.NewSyncTypeRegistry[Something]("__type").Add(Something1{}).Append(Something2{})
...
func (suite *SyncTypeRegistrySuite) TestShouldFailWithoutType() {
	registry := argo.NewSyncTypeRegistry[Something]().Add(Something1{}).Append(Something2{})
...
func (suite *SyncTypeRegistrySuite) TestShouldFailWithInvalidType() {
	registry := argo.NewSyncTypeRegistry[Something]().Add(Something1{}).Append(Something2{})
...
func (suite *SyncTypeRegistrySuite) TestShouldFailWithInvalidJSON() {
	registry := argo.NewSyncTypeRegistry[Something]().Add(Something1{}).Append(Something2{})
...
func (suite *SyncTypeRegistrySuite) TestShouldFailWithInvalidDataType() {
	registry := argo.NewSyncTypeRegistry[Something]().Add(Something1{}).Append(Something2{})
...
func (suite *SyncTypeRegistrySuite) TestShouldFailWithInvalidData() {
	registry := argo.NewSyncTypeRegistry[Something]().Add(Something1{}).Append(Something2{})
